...
export default function QuestionListPage() {
  ...
  return (
    <main className="max-w-4xl mx-auto p-8 space-y-8 bg-white min-h-screen">
      ...
      <SearchHeader onToggleExpand={() => setIsAllExpanded(!isAllExpanded)} isAllExpanded={isAllExpanded} />
      ...
      <section className="space-y-4">
        {MOCK_DATA.categories.map((category) => (
          <CategorySection key={category.id} category={category} forceExpand={isAllExpanded}/>
        ))}
      </section>
    </main>
  );
